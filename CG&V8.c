...
{
glPushMatrix(); glTranslated(0.5,0.5*thickness,0.5);
glScaled(1.0,thickness,1.0); glutSolidCube(1.0);
glPopMatrix();
}
...
tableleg(legt,legl); glTranslated(0,0,-2*dist);
tableleg(legt,legl); glPopMatrix();
}
...
glMaterialfv(GL_FRONT,GL_SHININESS,mat_shininess); GLfloat
lightint[]={0.7f,0.7f,0.7f,1.0f};
...
glPushMatrix(); glRotated(90.0,0.0,0.0,1.0);
